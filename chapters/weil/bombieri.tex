...
% TODO: Connect with trace: Later refer to trace function properties from trace and field
...
\end{lemma}
\begin{proof}
  The first statement is obvious and the later follows from trace properties.
\end{proof}
