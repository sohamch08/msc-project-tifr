...
\begin{Definition}{Diagonall Equations}{}
  \index{diagonal equation}\index{diagonal equation!at zero}%
...
\index{Jacobi sum!application to diagonal equations}%
Now we express the number of solutions $Z\lt(a_1X_1^{k_1}+\cdots+a_nX_n^{k_n}=\alpha\rt)$ in terms of Jacobi sums.\index{Jacobi sum} 
...
\begin{Theorem}{Solution Count for Diagonal Equations at Zero}{thm:diagonal-count-zero}
  \index{diagonal equation!at zero}\index{solution count!diagonal equations}%
