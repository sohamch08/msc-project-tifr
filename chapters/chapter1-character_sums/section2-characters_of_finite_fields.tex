...
We first turn to the additive group of $\bbF_q$. Characters of the additive group $\bbF_q$ are called \emph{additive characters} of $\bbF_q$. We denote the set of all additive characters of $\bbF_q$ by $\bm{\mcX}_q$. 
...
\begin{Theorem}{}{thm:add-char-define}
  For $\beta\in\bbF_q$, define the function $\chi_{\beta}$ with $\chi_{\beta}(\alpha)=\chi_1(\beta\cdot \alpha)$ for all $\alpha\in\bbF_q$. Then $\chi_{\beta}$ is an additive character of $\bbF_q$ and every additive character of $\bbF_q$ is obtained this way i.e. for all $\chi\in\Xq$, there exists $\beta\in\bbF_q$ such that for all $\alpha\in\bbF_q$ we have $\chi(\alpha)=\chi_{\beta}(\alpha)$. 
\end{Theorem}
\begin{proof}
...
\begin{lemma}{}{lem:mult-char-define}
...
\end{observation}
\begin{observation}
  If $\psi\in\Mq$ is the principle multiplicative character of $\bbF_q$ then $\psi(-1)=-1$. 
\end{observation}
...
Similarly if $\psi_1$ and $\lambda_1$ are principle multiplicative characters of $\bbF_q$ and $E$ respectively then, $$\lambda_1(\alpha)=\psi_1(\norm_{E/\bbF_q}(\alpha))\quad \forall\ \alpha\in E^*$$ where $\norm_{E/\bbF_q}$ is the norm function from $E$ to $\bbF_q$.
