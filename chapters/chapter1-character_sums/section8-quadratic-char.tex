...
We now give another special formula for Gaussian sums which has a lot of application. But this has a restriction on the underlying field. 
\begin{Theorem}{Stickelberger's Theorem}{thm:stickelberger}
  Let $q$ be a prime power and $\lm\in\Mq$ be a non-trivial multiplicative character of $\bbF_{q^2}$ of order $m$ such that $m\mid q-1$. Let $\chi_1$ be the canonical additive character of $\bbF_{q^2}$. Then $$G(\lm,\chi_1)=\begin{cases}
