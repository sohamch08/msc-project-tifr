...
\end{Theorem}
\begin{proof}
  Let $\chi_1$ be the canonical additive character of $\bbF_p$ and $\eta$ is the quadratic character of $\bbF_p$. Then by \lemref{lem:gaussian-sum-identity} we gave $G^2(\eta,\chi_1)=(-1)^{\nicefrac{(p-1)}2}\cdot p$. So $$G^q(\eta,\chi_1)= G(\eta,\chi_1)\cdot \lt( G^2(\eta,\chi_1)\rt)^{\nicefrac{(q-1)}{2}}=(-1)^{\nicefrac{(p-1)(q-1)}{4}}\cdot p\cdot G(\eta,\chi_1)$$Now we calculate $G^q(\eta,\chi_1)$ in different way. 
\end{proof}