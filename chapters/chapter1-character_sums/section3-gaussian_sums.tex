...
We can give a relation between Gaussian sums a multiplicative and additive character and Gaussian sum of lifted characters. To build that relation we need the theory of $L$-functions in \autoref{l-functions}. Later we proved the \DHthm which gives this relation. 
