...
In the next section we will define another hybrid sum called \emph{Jacobi Sums}. Like Gaussian sum this also has many important applications. In the later sections we will use both Gaussian sums and Jacobi Sums to prove many interesting results