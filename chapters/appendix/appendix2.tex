...
% TODO: Hasse Derivative Properties
...
\end{definition}
\begin{Theorem}{Hasse Derivative Properties}{thm:hasse-derivative-properties}
	Let $P(\ovX), Q(\ovX)\in \bbF[\ovX]$ and let $\ovi, \ovj$ be vectors of non-negative integers. Then:\begin{enumerate}
