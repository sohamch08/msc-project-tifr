...
\begin{Theorem}{Analytic Continuation of the Completed Zeta Function}{zeta-functional-equation}%
  \index{zeta function!completed}\index{functional equation!for the zeta function}%
...
\index{zeta function!over $\bbF_q[X]$}%
...
\begin{Theorem}{}{thm:l-function-root-factorisation}%
  \index{L-function!root factorisation}%
