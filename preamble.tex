...
\usepackage{tikz}
\usepackage[missing=Untracked]{gitinfo2}
\providecommand{\gitUnpushedCount}{0}% fallback when gin file absent
...
\definecolor{gitbright}{RGB}{220,220,255}   % bright white-blue

\newcommand{\gitinfonotecolour}{gitdim}

\newcommand{\gitsep}{%
  \textcolor{gitaccent}{\,\raisebox{0.2ex}{\rule{0.4pt}{1.2ex}}\,}%
}

\newcommand{\gitinfonote}{%
  \texttt{\footnotesize%
    \href{https://github.com/sohamch08/msc-project-tifr}{%
      \textcolor{gitaccent}{\faGithub\texttt{\textup{sohamch08/msc-project-tifr}}}%
    }%
    \;\gitsep\;%
    \textcolor{gitaccent}{\normalfont\faGit*}\,%
    \textcolor{gitmid}{\texttt{\gitAbbrevHash}}%
    \;\gitsep\;%
    \textcolor{gitaccent}{\normalfont\faCalendar}\,%
    \textcolor{gitdim}{\texttt{\gitAuthorIsoDate}}%
    \ifnum\gitUnpushedCount>0%
      \;\gitsep\;%
      \textcolor{gitaccent}{\normalfont\faArrowUp}\,%
      \textcolor{gitmid}{\texttt{\gitUnpushedCount}\,unpushed}%
    \fi%
  }%
}
...
\providecommand*{\Autoref}[1]{%
	...
	%\def\lineautorefname{Line} % For normal lines
